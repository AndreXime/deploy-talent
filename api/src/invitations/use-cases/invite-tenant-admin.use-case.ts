...
export class InviteTenantAdminUseCase {
  private readonly logger = new Logger(InviteTenantAdminUseCase.name)
  ...
  async execute(input: InviteTenantAdminInput) {
    ...
    try {
      await this.notifier.notifyTenantAdminInvited({
